        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                      ...
                      child: commenButton(
                        ...
                        callback: () async {
                          ...
                          if (flightkey.currentState!.validate()) {
                            ...
                            prefs.setStringList("agelist", agelist1);
              ...
              Padding(
                padding: const EdgeInsets.only(bottom: 8, top: 13, left: 8),
                child: StreamBuilder(
                        ...
                        return Padding(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              var trto = getWordBeforeAirport(
                                  data[index]["travelingTo"]);
                              ...
                              return Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    store.setStringList("agelist", agesString);
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          ListTile(
                                            ...
                                            subtitle: Text(
                                                "$date  ${int.parse(data[index]["adult"]) + int.parse(data[index]["child"])} Traveller"),
                                          ),
                                        ],
                                      ),
                                    ),

...
class _TriptabState extends State<Triptab> {
  ...
  addToFavorite(String ide) async {
    ...
    await collectionReference
        ...
        .doc(fvopkg.first.id)
        .set({
      "latitude": fvopkg.first.latitude,
      "longitude": fvopkg.first.longitude,
      "pid": fvopkg.first.id,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        foundlist.isEmpty
                            ? Padding(
                                padding:
                                    EdgeInsets.only(top: mq.size.height * 0.1),
                                child: Column(
                                        ...
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) =>
                                                ...
                                                package: Package(
                                                    latitude: foundlist[index]
                                                        .latitude,
                                                    longitude: foundlist[index]
                                                        .longitude,
                                                    id: foundlist[index].id,
                                                    ...
                                                    endDate: foundlist[index]
                                                        .endDate,
                                                    imgUrl:
                                                        foundlist[index].imgUrl,
                                                    decs: foundlist[index].decs,
                                                    price:
                                                        foundlist[index].price,
                                                    img1: foundlist[index].img1,
                                                    img2: foundlist[index].img2,
                                                    img3: foundlist[index].img3,
                                                    img4: foundlist[index].img4,
                                                    ...
                                                    hotelImg: foundlist[index]
                                                        .hotelImg,
                                                    hotelAdd: foundlist[index]
                                                        .hotelAdd,
                                                    hotelPhone: foundlist[index]
                                                        .hotelPhone,
                                                    hotelRate: foundlist[index]
                                                        .hotelRate,
                                                    retunfligthdate: foundlist[index]
                                                        .retunfligthdate,
                                                    retunreachfligthdate:
                                                        foundlist[index].retunreachfligthdate,
